...
var G__57110 = o;
reagent.impl.template.goog$module$goog$object.set(G__57110,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__57147 = o;
reagent.impl.template.goog$module$goog$object.set(G__57147,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__57153 = props;
var G__57153__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57153,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__57153);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57153__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__57153__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__57177 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57177,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__57177;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__57224){
var map__57226 = p__57224;
var map__57226__$1 = cljs.core.__destructure_map(map__57226);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57226__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__57301_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__57301_SHARP_);
}));
} else {
return null;
}
...
var vec__57380 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(2),null);
...
var temp__5808__auto___57408 = reagent.impl.template.key_from_vec(v);
if((temp__5808__auto___57408 == null)){
} else {
var key_57413 = temp__5808__auto___57408;
(jsprops.key = key_57413);
}
...
var temp__5808__auto___57414 = reagent.impl.template.key_from_vec(argv);
if((temp__5808__auto___57414 == null)){
} else {
var key_57415 = temp__5808__auto___57414;
(jsprops.key = key_57415);
}
...
var G__57384 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__57384) : reagent.impl.template.as_element.call(null,G__57384));
} else {
var temp__5808__auto___57416 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5808__auto___57416 == null)){
} else {
var key_57417 = temp__5808__auto___57416;
(jsprops.key = key_57417);
}
...
var G__57386 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__57386)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57386)){
return x;
} else {
...
var len__5769__auto___57418 = arguments.length;
var i__5770__auto___57419 = (0);
while(true){
if((i__5770__auto___57419 < len__5769__auto___57418)){
args__5775__auto__.push((arguments[i__5770__auto___57419]));

var G__57420 = (i__5770__auto___57419 + (1));
i__5770__auto___57419 = G__57420;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq57387){
var G__57388 = cljs.core.first(seq57387);
var seq57387__$1 = cljs.core.next(seq57387);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57388,seq57387__$1);
}));
...
break;
default:
var G__57427 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__57427;
continue;
...
var ctx = ({});
var vec__57391 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57391,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57391,(1),null);
...
var G__57394 = (cljs.core.count(argv) - first_child);
switch (G__57394) {
case (0):
