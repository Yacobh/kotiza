...
var G__46964 = devtools.prefs.pref(v);
v = G__46964;
continue;
} else {
return v;
...
}catch (e46882){var _e__45803__auto__ = e46882;
return false;
}})();
...
}catch (e46889){var _e__45803__auto__ = e46889;
return false;
}})();
...
}catch (e46899){var _e__45803__auto__ = e46899;
return false;
}}
}
});
...
var vec__46929 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46929,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46929,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46939_SHARP_);
}),template);
});
