...
var len__5769__auto___47086 = arguments.length;
var i__5770__auto___47087 = (0);
while(true){
if((i__5770__auto___47087 < len__5769__auto___47086)){
args__5775__auto__.push((arguments[i__5770__auto___47087]));

var G__47088 = (i__5770__auto___47087 + (1));
i__5770__auto___47087 = G__47088;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq46997){
var G__47001 = cljs.core.first(seq46997);
var seq46997__$1 = cljs.core.next(seq46997);
var G__47002 = cljs.core.first(seq46997__$1);
var seq46997__$2 = cljs.core.next(seq46997__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47001,G__47002,seq46997__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__47042_SHARP_){
return (!((cljs.core.meta(p1__47042_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47047__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e47048){var _e__45803__auto__ = e47048;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e47050){var _e__45803__auto__ = e47050;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__47052 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__47053 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__47053);

try{var map__47054 = opts;
var map__47054__$1 = cljs.core.__destructure_map(map__47054);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47054__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__47052);
}});
...
var temp__5802__auto___47102 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___47102)){
var managed_print_level_47103 = temp__5802__auto___47102;
var _STAR_print_level_STAR__orig_val__47076_47104 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__47077_47105 = managed_print_level_47103;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__47077_47105);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__47060_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__47060_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__47076_47104);
}} else {
job_fn();
}
