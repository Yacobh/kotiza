...
}catch (e49312){var _e__45803__auto__ = e49312;
return false;
...
}catch (e49314){var _e__45803__auto__ = e49314;
return false;
...
}catch (e49321){var _e__45803__auto__ = e49321;
return false;
...
}catch (e49323){var _e__45803__auto__ = e49323;
return false;
...
}catch (e49325){var _e__45803__auto__ = e49325;
return false;
}})())){
...
}catch (e49327){var _e__45803__auto__ = e49327;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__49341 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__49342 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__49342);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__49341);
}});
});
...
return (function() { 
var G__49374__delegate = function (args){
...
while (G__49375__i < G__49375__a.length) {G__49375__a[G__49375__i] = arguments[G__49375__i + 0]; ++G__49375__i;}
  args = new cljs.core.IndexedSeq(G__49375__a,0,null);
} 
return G__49374__delegate.call(this,args);};
G__49374.cljs$lang$maxFixedArity = 0;
G__49374.cljs$lang$applyTo = (function (arglist__49376){
var args = cljs.core.seq(arglist__49376);
return G__49374__delegate(args);
});
