...
var i_51595 = (0);
while(true){
if((i_51595 < arr.length)){
(arr[i_51595] = null);

var G__51596 = (i_51595 + (1));
i_51595 = G__51596;
continue;
} else {
}
...
var i_51604 = (self__.level + (1));
while(true){
if((i_51604 <= (new_level + (1)))){
(update[i_51604] = self__.header);

var G__51605 = (i_51604 + (1));
i_51604 = G__51605;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_51606 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_51606[i]));
} else {
x__$2.forward.push((((i < links_51606.length))?(links_51606[i]):null));
}

if((i < links_51606.length)){
(links_51606[i] = x__$2);
} else {
links_51606.push(x__$2);
}
...
var i_51608 = (0);
while(true){
if((i_51608 <= self__.level)){
var links_51609 = (update[i_51608]).forward;
if((x__$1 === (((i_51608 < links_51609.length))?(links_51609[i_51608]):null))){
(links_51609[i_51608] = (x__$1.forward[i_51608]));

var G__51610 = (i_51608 + (1));
i_51608 = G__51610;
continue;
} else {
...
var G__51613 = nx;
var G__51614 = (level__$1 - (1));
x = G__51613;
level__$1 = G__51614;
continue;
} else {
var G__51616 = x;
var G__51617 = (level__$1 - (1));
x = G__51616;
level__$1 = G__51617;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__51620 = nx;
var G__51621 = (level__$1 - (1));
x = G__51620;
level__$1 = G__51621;
continue;
} else {
var G__51622 = x;
var G__51623 = (level__$1 - (1));
x = G__51622;
level__$1 = G__51623;
continue;
}
