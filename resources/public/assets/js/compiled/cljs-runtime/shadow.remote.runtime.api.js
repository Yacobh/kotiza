...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_51585 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_51585(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_51586 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_51586(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_51587 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_51587(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_51590 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_51590(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_51593 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_51593(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_51598 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_51598(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__51583,callback){
var map__51584 = p__51583;
var map__51584__$1 = cljs.core.__destructure_map(map__51584);
var input = map__51584__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51584__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51584__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
