...
if((i < len)){
var k = (ks[i]);
var G__57062 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),reagent.impl.component.goog$module$goog$object.get(o,k));
var G__57063 = (i + (1));
m = G__57062;
i = G__57063;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__56898 = c;
var G__56898__$1 = (((G__56898 == null))?null:G__56898.prototype);
if((G__56898__$1 == null)){
return null;
} else {
return G__56898__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__56903 = c;
var G__56903__$1 = (((G__56903 == null))?null:G__56903.prototype);
if((G__56903__$1 == null)){
return null;
} else {
return G__56903__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__57069__delegate = function (args){
var G__56920 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__56920) : reagent.impl.component.as_element.call(null,G__56920));
};
var G__57069 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57070__i = 0, G__57070__a = new Array(arguments.length -  0);
while (G__57070__i < G__57070__a.length) {G__57070__a[G__57070__i] = arguments[G__57070__i + 0]; ++G__57070__i;}
  args = new cljs.core.IndexedSeq(G__57070__a,0,null);
} 
return G__57069__delegate.call(this,args);};
G__57069.cljs$lang$maxFixedArity = 0;
G__57069.cljs$lang$applyTo = (function (arglist__57071){
var args = cljs.core.seq(arglist__57071);
return G__57069__delegate(args);
});
G__57069.cljs$core$IFn$_invoke$arity$variadic = G__57069__delegate;
return G__57069;
})()
;})(c,f,_,res))
:res);
...
var G__56921 = c;
var G__56921__$1 = (((G__56921 == null))?null:G__56921.constructor);
if((G__56921__$1 == null)){
return null;
} else {
return G__56921__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__56943 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__56944 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__56944);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__56943);
}});
...
var c = this;
var G__57024_57080 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__57024_57080 == null)){
} else {
reagent.ratom.dispose_BANG_(G__57024_57080);
}
...
var renders_57094 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_57095 = cljs.core.first(cljs.core.vals(renders_57094));
...
if((cljs.core.count(renders_57094) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_57094))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_57095)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_57095], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__57047 = o;
reagent.impl.component.goog$module$goog$object.set(G__57047,cljs.core.name(k),v);
