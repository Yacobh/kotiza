...
return [(function (){var pred__57531 = cljs.core.instance_QMARK_;
var expr__57532 = reactive_val;
if(cljs.core.truth_((pred__57531.cljs$core$IFn$_invoke$arity$2 ? pred__57531.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__57532) : pred__57531.call(null,reagent.ratom.RAtom,expr__57532)))){
return "ra";
} else {
if(cljs.core.truth_((pred__57531.cljs$core$IFn$_invoke$arity$2 ? pred__57531.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__57532) : pred__57531.call(null,reagent.ratom.RCursor,expr__57532)))){
return "rc";
} else {
if(cljs.core.truth_((pred__57531.cljs$core$IFn$_invoke$arity$2 ? pred__57531.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__57532) : pred__57531.call(null,reagent.ratom.Reaction,expr__57532)))){
return "rx";
} else {
if(cljs.core.truth_((pred__57531.cljs$core$IFn$_invoke$arity$2 ? pred__57531.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__57532) : pred__57531.call(null,reagent.ratom.Track,expr__57532)))){
return "tr";
} else {
return "other";
}
