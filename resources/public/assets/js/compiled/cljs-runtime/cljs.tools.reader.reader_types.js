...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_49580 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_49580(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_49581 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_49581(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49583 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49583(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49586 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49586(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49587 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49587(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49591 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49591(reader);
}
});
...
var G__49622 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__49623 = s.append(c);
c = G__49622;
s = G__49623;
continue;
}
